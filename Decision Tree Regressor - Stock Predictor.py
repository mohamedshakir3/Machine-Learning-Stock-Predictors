...
######################################################################################
# Predicts historical closing price of a stock using a decision tree regressor model #
######################################################################################
...
def main():
    ...
    Visualize(df,tree_prediction,featureData)
...
def Visualize(dataframe,predictions,featureDataSet):
    ...
    plt.title('Decesion Tree Regressor Model')
    plt.xlabel('Date')
    plt.ylabel('Close Price')
    plt.plot(dataframe['Close'])
    plt.plot(realData[['Close', 'Predictions']], alpha = 0.35)
